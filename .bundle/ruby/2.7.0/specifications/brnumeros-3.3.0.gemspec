...
Gem::Specification.new do |s|
  ...
  s.date = "2012-09-20"
  s.description = "brnumeros \u00E9 uma das gems que compoem o Brazilian Rails".freeze
  ...
  s.summary = "brnumeros \u00E9 uma das gems que compoem o Brazilian Rails".freeze
