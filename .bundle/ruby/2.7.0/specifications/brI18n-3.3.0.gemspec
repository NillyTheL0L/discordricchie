...
Gem::Specification.new do |s|
  ...
  s.date = "2012-09-20"
  s.description = "brtraducao \u00E9 uma das gems que compoem o Brazilian Rails".freeze
  ...
  s.summary = "brtraducao \u00E9 uma das gems que compoem o Brazilian Rails".freeze
